...
export class NotificationsComponent implements OnInit {
  ...
  constructor(private toastr: ToastrService, private RestaurantServ: RestaurantService) {}
  ...
  ngOnInit() {
    this.RestaurantServ.getAllRestaurant().subscribe(res=>this.Restaurants=res);
  }
